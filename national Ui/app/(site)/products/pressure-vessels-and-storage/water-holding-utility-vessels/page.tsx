        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-[330px_minmax(0,1fr)] xl:gap-10">
          ...
          <div className="min-w-0">
            ...
            <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
              <img
                src="/product/9.jpg"
                alt="Water Holding / Utility Vessels"
            ...
            <div className="mt-8 rounded-2xl border border-gray-200 bg-white p-6 shadow-sm sm:p-8 lg:p-10">
              ...
              <p className="mt-4 text-[15px] leading-8 text-[#5b6472]">
                NESF fabricates water holding and utility vessels for industrial
                plants, built for durability, maintainability, and reliable
              ...
              <ul className="mt-4 space-y-3 text-[15px] text-[#5b6472]">
                ...
                <li>Stabilizing supply for utility pumps and pipelines</li>
              </ul>
              ...
              <ul className="mt-4 space-y-3 text-[15px] text-[#5b6472]">
                <li>Vertical or horizontal designs</li>
                <li>Manhole, vent, overflow, drain, and level connections</li>
                <li>
                  Internal coating for corrosion, such as epoxy or bituminous
                  systems as specified
                </li>
                <li>Platforms and ladders for vertical tanks</li>
                <li>
              ...
              <ul className="mt-4 space-y-3 text-[15px] text-[#5b6472]">
                <li>Carbon steel or stainless steel, service dependent</li>
              </ul>
              ...
              <ul className="mt-4 space-y-3 text-[15px] text-[#5b6472]">
                <li>
                  Controlled fabrication with QA/QC, welding qualification, and
                  traceability
                </li>
                <li>Hydro testing and leak checks as specified</li>
                <li>Surface preparation and coating DFT checks if coated</li>
              </ul>
              ...
              <ul className="mt-4 space-y-3 text-[15px] text-[#5b6472]">
                <li>Vessel, supports, and nozzles</li>
              ...
              <ul className="mt-4 space-y-3 text-[15px] text-[#5b6472]">
                <li>
                  Capacity, temperature, and water type, such as raw, DM, soft,
                  or service water
                </li>
                <li>Corrosion allowance and coating specification</li>
                <li>Nozzle list / P&amp;ID and site constraints</li>
              </ul>

              <div className="mt-10 rounded-2xl border border-[#f0a14a]/30 bg-[#fff7ef] p-6">
                <p className="text-base font-bold text-[#0f223d]">
                  Get a utility vessel that matches your plant&apos;s
                  maintenance and uptime needs.
                </p>
              </div>
              ...
              <div className="mt-12">
                <ProductEnquiryForm
                  ...
                  subtitle="Share capacity, water type, corrosion allowance, coating spec, nozzle list, and site constraints."
