...
const featuredProduct = productDetails["venturi-scrubbers"];

export const metadata = buildMetadata({
  title: "Pollution Control & Gas Handling | National Engineers",
  description:
    "Explore pollution-control and gas-handling equipment fabricated by NESF, including Venturi scrubbers, wet scrubber systems, flue gas ducting, and scrubber internals.",
  path: "/products/pollution-control-and-gas-handling",
  image: featuredProduct.image,
  keywords: [
    "pollution control equipment manufacturer",
    "wet scrubber manufacturer",
    "venturi scrubber fabrication",
    "flue gas ducting",
    "scrubber internals",
  ],
});

export default function PollutionControlGasHandlingPage() {
  return (
    <main className="bg-white text-gray-950">
      <section className="relative isolate overflow-hidden bg-black">
        ...
        <div className="relative mx-auto flex min-h-105 max-w-425 flex-col justify-end px-4 pb-16 pt-24 sm:px-6 lg:px-8">
          ...
          <p className="mt-5 max-w-2xl text-base leading-8 text-white/80 sm:text-lg">
            Fabricated pollution-control equipment and gas-handling systems
            built around exhaust duty, corrosion conditions, maintainability,
            and reliable plant integration.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-425 px-4 py-14 sm:px-6 lg:px-8 lg:py-18">
        ...
        <h2 className="mt-3 text-3xl font-bold sm:text-4xl">
          Explore Pollution Control & Gas Handling
        </h2>
