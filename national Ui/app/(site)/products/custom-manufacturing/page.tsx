...
const featuredProduct = productDetails["heavy-plate-fabrication"];

export const metadata = buildMetadata({
  title: "Custom Manufacturing as per Client Drawing | National Engineers",
  description:
    "Explore custom manufacturing by NESF, including heavy plate fabrication, multi-material steel fabrication, erection support, and repair or modification jobs.",
  path: "/products/custom-manufacturing",
  image: featuredProduct.image,
  keywords: [
    "custom manufacturing as per drawing",
    ...
    <main className="bg-white text-gray-950">
      <section className="relative isolate overflow-hidden bg-black">
        ...
        <div className="relative mx-auto flex min-h-105 max-w-425 flex-col justify-end px-4 pb-16 pt-24 sm:px-6 lg:px-8">
          ...
          <h1 className="mt-4 max-w-5xl text-4xl font-bold text-white sm:text-5xl lg:text-6xl">{CATEGORY_NAME}</h1>
          <p className="mt-5 max-w-2xl text-base leading-8 text-white/80 sm:text-lg">
            Build-to-drawing manufacturing, site support, and modification services planned around materials, inspection requirements, schedule, and practical execution.
          </p>
        </div>
      </section>
      <section className="mx-auto max-w-425 px-4 py-14 sm:px-6 lg:px-8 lg:py-18">
        ...
        <h2 className="mt-3 text-3xl font-bold sm:text-4xl">Explore Custom Manufacturing</h2>
