...
const featuredProduct = productDetails["condensers-water-condensers"];

export const metadata = buildMetadata({
  title: "Process Equipment & Heat Transfer | National Engineers",
  description:
    "Explore process equipment and heat transfer fabrication by NESF, including condensers, exchanger shells, process columns, modular skids, and custom chemical process equipment.",
  path: "/products/process-equipment-and-heat-transfer",
  image: featuredProduct.image,
  keywords: [
    "process equipment manufacturer",
    "heat transfer equipment manufacturer",
    "industrial condenser fabrication",
    "water condenser manufacturer",
    "heat exchanger shell fabrication",
...
export default function ProcessEquipmentHeatTransferPage() {
  return (
    <main className="bg-white text-gray-950">
      <section className="relative isolate overflow-hidden bg-black">
        ...
        <div className="relative mx-auto flex min-h-105 max-w-425 flex-col justify-end px-4 pb-16 pt-24 sm:px-6 lg:px-8">
          ...
          <p className="mt-5 max-w-2xl text-base leading-8 text-white/80 sm:text-lg">
            Engineered process equipment and heat transfer fabrication designed
            around plant duty, service conditions, maintainability, and project
      ...
      <section className="mx-auto max-w-425 px-4 py-14 sm:px-6 lg:px-8 lg:py-18">
        ...
        <h2 className="mt-3 text-3xl font-bold sm:text-4xl">
          Explore Process Equipment & Heat Transfer
        </h2>
