...
const featuredProduct = productDetails["hoppers-flakes-hoppers"];

export const metadata = buildMetadata({
  title: "Material Handling & Bulk Storage | National Engineers",
  description:
    "Explore bulk-material handling and storage equipment fabricated by NESF, including hoppers, silos, bins, chutes, tow cans, and custom handling equipment.",
  path: "/products/material-handling-and-storage",
  image: featuredProduct.image,
  keywords: [
    "bulk material handling equipment",
    "industrial hopper manufacturer",
    "silo fabrication",
    "bulk handling chutes",
    "custom bulk handling fabrication",
  ],
});

export default function MaterialHandlingStoragePage() {
  return (
    <main className="bg-white text-gray-950">
      <section className="relative isolate overflow-hidden bg-black">
        ...
        <div className="relative mx-auto flex min-h-105 max-w-425 flex-col justify-end px-4 pb-16 pt-24 sm:px-6 lg:px-8">
          ...
          <p className="mt-5 max-w-2xl text-base leading-8 text-white/80 sm:text-lg">
            Fabricated bulk-material storage and handling equipment built around material flow, wear protection, maintainability, and reliable plant integration.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-425 px-4 py-14 sm:px-6 lg:px-8 lg:py-18">
        ...
        <h2 className="mt-3 text-3xl font-bold sm:text-4xl">Explore Material Handling & Storage</h2>
