...
const featuredProduct = productDetails["ahu-ducts-gi-ss"];

export const metadata = buildMetadata({
  title: "HVAC & Industrial Ducting | National Engineers",
  description:
    "Explore HVAC and industrial ducting fabricated by NESF, including AHU ducts, process ducting systems, custom fittings, and insulated duct casings.",
  path: "/products/hvac-and-industrial-ducting",
...
export default function HvacIndustrialDuctingPage() {
  return (
    <main className="bg-white text-gray-950">
      <section className="relative isolate overflow-hidden bg-black">
        ...
        <div className="relative mx-auto flex min-h-105 max-w-425 flex-col justify-end px-4 pb-16 pt-24 sm:px-6 lg:px-8">
          ...
          <p className="mt-5 max-w-2xl text-base leading-8 text-white/80 sm:text-lg">
            Fabricated HVAC and industrial ducting built around airflow duty, service conditions, maintainability, and accurate plant integration.
          </p>
        </div>
      </section>
      <section className="mx-auto max-w-425 px-4 py-14 sm:px-6 lg:px-8 lg:py-18">
        ...
        <h2 className="mt-3 text-3xl font-bold sm:text-4xl">Explore HVAC & Industrial Ducting</h2>
