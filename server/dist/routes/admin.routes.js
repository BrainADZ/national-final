...
router.get("/me", auth_middleware_1.requireAdmin, (req, res) => {
...
router.get("/ads-enquiries", adsEnquiry_controller_1.listAdsEnquiries);
router.delete("/ads-enquiries/:id", adsEnquiry_controller_1.deleteAdsEnquiry);
